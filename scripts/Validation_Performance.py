...
DAPL = DeepAPL_SC('blast_class_colornorm',device=gpu)
DAPL.Import_Data(directory='../Data/Final/Validation', Load_Prev_Data=False, classes=classes,
                 include_cell_types=cell_types,color_norm=True,save_data=False)
DAPL.Ensemble_Inference()
DAPL.counts = np.ones_like(DAPL.predicted)*100
...
sns.violinplot(data=DAPL.Cell_Pred,x='Label',y='APL',cut=0)